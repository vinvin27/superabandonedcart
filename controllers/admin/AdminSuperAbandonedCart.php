...
class AdminSuperAbandonedCartController extends AdminController
{
    public function __construct()
    {
        ...
        $this->fields_list = array(
            ...
            'newsletter_only' => array(
                'title' => $this->l('Newsletter Only'),
                'width' => '70',
                'align' => 'center',
                'activeVisu' => 'newsletter_only',
                'type' => 'bool',
                'orderby' => false,
                'filter' => false,
                'search' => false,
    ...
    public function postProcess()
    {
        ...
        if (Tools::isSubmit('submitAddcampaign')) {
            ...
            if ((!$id_campaign = (int) Tools::getValue('id_campaign')) && empty($this->errors)) {
                ...
                $campaign->newsletter_only = Tools::getValue('newsletter_only');
